...
vim.opt.completeopt = "menu,menuone,noselect" -- Use GUI menus for completions
vim.opt.conceallevel = 2 -- Hide * markup for bold and italic, but not markers with substitutions
vim.opt.confirm = true -- Confirm to save changes before exiting modified buffer
vim.opt.cursorline = true -- Enable highlighting of the current line
vim.opt.expandtab = true -- Use spaces instead of tabs
vim.opt.formatoptions = "jcroqlnt" -- formatting options
...
vim.opt.splitkeep = "screen" -- Keep scroll when splitting
vim.opt.splitright = true -- Put new windows right of current
vim.opt.tabstop = 2 -- Number of spaces tabs count for
vim.opt.timeoutlen = 300 -- Lower timeout to feel more responsive
vim.opt.undofile = true -- Maintain undo history between sessions
vim.opt.undolevels = 10000 -- How many undo levels to keep
vim.opt.updatetime = 200 -- Keeps swap file updated in case of crash
...
-- Remove "How to disable mouse" prompt on mouse menus
